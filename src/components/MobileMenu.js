...
function MobileMenu({shouldShow}) {
    ...
    return (
        ...
        <ul className={shouldShow?'mobile-menu__main-links':'mobile-menu__main-links--hidden'}>
            ...
            <li className='mobile-menu__item'><Link to='/savoir-vivre__miedzynarodowo'>międzynarodowo</Link></li>
            </ul>
        <ul className={shouldShow?'mobile-menu__main-links':'mobile-menu__main-links--hidden'}>
            ...
            <li className='mobile-menu__item'><Link to='/dress-code__miedzynarodowo'>międzynarodowo</Link></li>
        </ul>
        </div>
    )
}
